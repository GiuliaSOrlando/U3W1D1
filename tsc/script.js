...
submitBtn.addEventListener("click", function (event) {
    ...
    let inputFirstPlayer = parseFloat(document.getElementById("first-player").value);
    // Memorizzo in un'altra variabile l'input del secondo giocatore
    let inputSecondPlayer = parseFloat(document.getElementById("second-player").value);
    ...
    if (inputFirstPlayer === randomNum && inputSecondPlayer === randomNum) {
        ...
        alert(`Il numero estratto è ${randomNum},  perciò entrambi i giocatori hanno indovinato il numero`);
    }
    else if (inputFirstPlayer !== randomNum &&
        inputSecondPlayer === randomNum) {
        console.log("Ha indovinato solo il secondo giocatore");
        alert(`Il numero estratto è ${randomNum},  perciò ha indovinato solo il secondo giocatore`);
    }
    else if (inputFirstPlayer === randomNum &&
        inputSecondPlayer !== randomNum) {
        console.log("Ha indovinato solo il primo giocatore");
        alert(`Il numero estratto è ${randomNum},  perciò ha indovinato solo il primo giocatore`);
    }
    else if (inputFirstPlayer !== randomNum &&
        inputSecondPlayer !== randomNum) {
        if (Math.abs(randomNum - inputFirstPlayer) >
